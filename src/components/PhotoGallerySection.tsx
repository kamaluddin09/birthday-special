...
export function PhotoGallerySection() {
  ...
  return (
    ...
    >
      ...
      {/* Gallery Header */}
      <div className="space-y-3 pt-4 max-w-2xl mx-auto z-10">
        ...
        <p className="text-sm sm:text-base text-[#FFE4EF]/80 font-light max-w-lg mx-auto">
          Every angle of you is pure magic. Drag or swipe horizontally to rotate through the memories.
        </p>
      </div>

      {/* The 3D Photo Gallery */}
      <div className="w-full my-auto py-8 z-10 flex items-center justify-center">
        <PhotoGallery3D />
      </div>
